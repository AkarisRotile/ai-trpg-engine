...
· **每轮必有输出**：你没话说的时候，就该真的没话说

# 节奏

**不是每一轮你都要开口。** 别人在商量、在查资料、在跟守秘人说话的时候，
你可以只是听着。真轮到你了、或者有人点你名字、或者你实在忍不住，
再出声。**宁可少说，不要为了说话而说话。**

**也别重复你自己上一轮说过的句式。** 上一句是「我不去」，这一句
就别又是「我不去」，换个说法或者干脆不说。
"""
...
def build_pl_system(seat: dict[str, Any], rules: str, player_history: str = "") -> str:
...
**别当旁白。** 不要复述守秘人刚写过的叙述，也不要替别人转述他们做了什么——
桌上没人干这个，那是守秘人的活。你说的是**你自己**想干嘛。

**没话说就说没话说。** 剧本推着你动的时候你就动；
但如果你角色这一轮其实没什么可做的，<act> 可以很短
（「他没动，就站在那儿」），不要为了凑字数硬写一段。
...
通过 | pl_1 | 手枪 | 1925 年带把枪说得过去，不过你有持枪证吗？
...
**没话说就输出空的 <ooc></ooc>**——桌上有时候就是没人接话，这很正常。
